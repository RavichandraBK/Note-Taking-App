...
import styles from './MobPopup.module.css'
import { useRef } from 'react'
import myContext from '../Contexts/mycontext';

const MobPopup = ({ handleClose, show }) => {
    ...
    const handleCreateNote = (clr, noteName) => {
        if (inputVal !== '') {
    ...
    return (
        <>
            ...
            <div className={showPopup} ref={chkClick}>
                ...
                {noteVar.invalid && (
                    <p style={{ fontFamily: 'Roboto', fontSize: '15px', display: 'block', marginTop: '0px', lineHeight: '0px', marginLeft: '20px' }}>
                        Invalid input
                    </p>
                )}
